...
save('./PEB_B_HS_Wtaste.mat', 'PEB', 'RCM');

% Hierarchical PEB model comparison (automatic search over reduced PEB models)
BMA = spm_dcm_peb_bmc(PEB);
save('./BMA_B_HS_Wtaste.mat', 'BMA'); % output used to inform replication, validation, and visualisation

% Review BMA results
% -----------------------------------------------------------------------
% Second-level effect: Mean
%   Threshold: Free energy, Positive evidence (Pp>.75)
%   Display as matrix: B-matrix (modulatory connectivity; Input Stress_MCue)
% -----------------------------------------------------------------------
